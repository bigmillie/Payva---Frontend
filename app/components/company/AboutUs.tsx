            ...
            <div className="flex font-famil flex-col justify-between gap-6">
              <div className="md:p-4">
                ...
                <p className="text-[#4D4D4D] text-base mb-4">
                  ...
                  makes that easier. We help Nigerians home and abroad move
                  money across the UK, Canada, and Nigeria with
          ...
          <div className="bg-[#004F4C] p-6 md:p-12 font-famil rounded-xl flex-1 mt-20">
            ...
            <div className="space-y-6">
              ...
              <p className="text-[#E6F9F7] text-base">
                ...
                countless immigrants know too well. Sending money back home or
                to Canada required far more effort than it should have. He
                needed to support his family, pay bills, and stay connected. The
                formal options were slow and expensive. The informal ones
                promised good rates but came with real fear—no protection, no
                guarantees, and no peace of mind until the money finally
                dropped.
              </p>
              <p className="text-[#E6F9F7] text-base">
                There were days he waited hours, refreshing Telegram chats,
                hoping the exchanger on the other end would release the funds.
                The rates kept shifting, the delays were frustrating, and the
                uncertainty never really went away. <br />
                Eventually, he realised this wasn&apos;t just his story. It was
                the story of millions of immigrants trying to support loved
                ones, build new lives, and manage their finances with dignity.
              </p>
              <p className="text-[#E6F9F7] text-base">
                Payva grew out of that frustration, but it&apos;s driven by
                something bigger: a promise that no one should have to risk
                their hard-earned money just to show up for family.
              </p>
              <p className="text-[#E6F9F7] text-base">
