...
export async function sendWelcomeEmail({ to, firstName }: EmailOptions) {
  ...
  const html = `
    <div style="font-family: sans-serif; line-height: 1.5; color: #1F2937; padding: 20px;">
      <img src="https://res.cloudinary.com/kodenigga/image/upload/v1766153647/icons-for%20email-templates/bxqju1mxghzve01l75lc.svg" alt="Payva Logo" style="width: 120px; padding-bottom: 30px;"/>
